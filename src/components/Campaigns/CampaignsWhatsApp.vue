      ...
      <v-col cols="11" class="py-0">
        <v-container fluid class="pt-0 mt-4">
          <v-row class="pt-1 mt-0" align="start" style="height:auto; width:100%">
            <CampaignsWaTabs style="height:100%; width:100%" />
          </v-row>
        </v-container>
      </v-col>
    </v-col>
...
<script>
import CampaignsWaTabs from "@/components/Campaigns/CampaignsWhatsApp/CampaignsWhatsAppTabs.vue";
// import CampaignView from "@/components/Campaigns/CampaignView.vue";
import CartAttempts from "../AbandonedCarts/CartAttempts.vue";
import TooltipIcon from "@/components/svgIcons/TooltipIcon";
// import CampaignsWhatsApp from "./CampaignsWhatsApp";

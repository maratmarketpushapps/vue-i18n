<template>
  <div class="stepsCompletedDialog">
    <v-row justify="center">
      <v-dialog v-model="showStepsCompletedDialog" persistent max-width="925px">
        <v-row class="pa-0 ml-0">
          <v-col cols="5" class="pa-0 image_modal_color">
            <v-col class="image_modal_join">
              <v-img
                src="@/assets/img/ModalStep/image-install-steps.png"
              ></v-img>
            </v-col>
          </v-col>
              ...
              <v-col cols="12" class="pl-0 pr-0 py-0">
                <v-card-title class="pa-0">
                  ...
                  <span class="headline headline_title" id="fix_font">{{
                    $t("ModalStepsCompleted." + recoveryType + "Title")
                  }}</span>
                </v-card-title>
              </v-col>
              <v-card-text class="px-0 pt-0 pb-0 spc_text">
                <div v-if="getIsGdprAffected" class="step_fl fbNotAvailable">
                  {{ $t("settingsPage.fbCard1.isGdprAffected") }}
                </div>

                <span class="step_fl">{{
                  $t("ModalStepsCompleted.stepsToComplete")
                }}</span>
                <v-row>
                  <v-col class="step_part_txt" cols="9">
                    ...
                    >
                      ...
                      {{
                        $t(
                          "ModalStepsCompleted." + recoveryType + "Instruction1"
                        )
                      }}
                    </router-link>
                  </v-col>
                ...
                <v-row>
                  <v-col class="step_part_txt" cols="9">
                    ...
                    >
                      ...
                      {{
                        $t(
                          "ModalStepsCompleted." + recoveryType + "Instruction2"
                        )
                      }}
                    </router-link>
                  </v-col>
                ...
                <v-row>
                  <v-col class="step_part_txt" cols="9">
                    ...
                    >
                      ...
                      {{
                        $t(
                          "ModalStepsCompleted." + recoveryType + "Instruction3"
                        )
                      }}
                    </router-link>
                  </v-col>
                  ...
                  <v-col class="py-0">
                    ...
                    >
                      <template left class="mr-4 pr-4">
                        <v-img
                          src="@/assets/img/ModalStep/icon-play-tutorial.png"
                          class="mr-3"
                        ></v-img>
                      </template>
...
export default {
  ...
  computed: {
    ...
    getStep1Done: function() {
      let fullResponseStepsCompleted = this.$store.getters.getStepsCompleted;
      return fullResponseStepsCompleted[this.recoveryType + "CartRecoverySteps"]
        .step1;
    },
